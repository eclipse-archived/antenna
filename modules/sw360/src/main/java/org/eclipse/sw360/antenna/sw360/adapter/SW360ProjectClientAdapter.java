...
public class SW360ProjectClientAdapter {
    ...
    public Optional<String> getProjectIdByNameAndVersion(IProject project, HttpHeaders header) throws ExecutionException {
        return getProjectIdByNameAndVersion(project.getProjectId(), project.getVersion(), header);
    }

    public Optional<String> getProjectIdByNameAndVersion(String projectName, String projectVersion, HttpHeaders header) throws ExecutionException {
    ...
    public String addProject(String projectName, String projectVersion, HttpHeaders header) throws ExecutionException, JsonProcessingException {
    ...
    public void addSW360ReleasesToSW360Project(String id, Collection<SW360Release> releases, HttpHeaders header) throws IOException, ExecutionException {
    ...
    public List<SW360SparseRelease> getLinkedReleases(String projectId, HttpHeaders header) throws ExecutionException {
