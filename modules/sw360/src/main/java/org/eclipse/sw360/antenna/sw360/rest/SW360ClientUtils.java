...
public class SW360ClientUtils {
    ...
    protected static List<SW360SparseRelease> getSw360SparseReleases(ResponseEntity<Resource<SW360ReleaseList>> response) throws AntennaException {
    ...
    protected static List<SW360SparseComponent> getSw360SparseComponents(ResponseEntity<Resource<SW360ComponentList>> response) throws AntennaException {
