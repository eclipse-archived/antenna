 ...
 */
package org.eclipse.sw360.antenna.rulestesting;
...
public class RulesTests extends AbstractDroolsValidatorTest {
    private static final String PATH_TO_RULES = "../../../../../policies/rules";
    ...
    public void testArtifactWithRuleAndFailedArtifact() throws Exception {
        ...
        addEvaluationPolicyResult(
                new DroolsEvaluationResult("A1",
                        "The hash of the component cannot be found in the data service.",
                        IEvaluationResult.Severity.FAIL, null));

        assertThat(rule(PATH_TO_RULES,"A1_Unknown_Artifact.drl").whenRunning())
    ...
    public void testArtifactWithRuleAndPassedArtifacts() throws Exception {
        ...
        assertThat(rule(PATH_TO_RULES,"A1_Unknown_Artifact.drl").whenRunning()).passesAllArtifacts();
    }
}