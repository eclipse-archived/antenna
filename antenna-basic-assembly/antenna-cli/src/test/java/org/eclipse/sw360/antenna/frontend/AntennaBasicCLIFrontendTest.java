...
public class AntennaBasicCLIFrontendTest extends AbstractAntennaCLIFrontendTest {

    public AntennaBasicCLIFrontendTest(Supplier<AbstractTestProjectWithExpectations> testDataSupplier, String name) {
        super(testDataSupplier, name);
    }

    @Override
    public AbstractAntennaCLIFrontend getAntennaFrontend(File pomFile) {
        return new AntennaBasicCLIFrontend(pomFile);
    }
    ...
    public void testExecutionUsingMainMethod()
        ...
        protoypeExecutionTest(() -> {
            ...
            AntennaBasicCLIFrontend.main(args);
        }, tf -> null);
    }
}
