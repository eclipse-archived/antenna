...
public class SW360ComponentClient {
    ...
    public SW360Component getComponent(String componentId, HttpHeaders header) throws IOException, AntennaException {
    ...
    public List<SW360Component> getComponents(HttpHeaders header) throws JsonProcessingException, AntennaException {
        HttpEntity<String> httpEntity = RestUtils.getHttpEntity(Collections.emptyMap(), header);
        ...
        if (response.getStatusCode() == HttpStatus.OK) {
            SW360Component<LinkObjects, SW360ComponentEmbedded> resource = response.getBody().getContent();
    ...
    public List< SW360Component> searchByName(String name, HttpHeaders header) throws AntennaException {
    ...
    public SW360Component createComponent(SW360Component sw360Component, HttpHeaders header) throws JsonProcessingException, AntennaException {
